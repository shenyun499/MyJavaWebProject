...
<%@ page import="com.bbs.article.*,java.util.*" %>
<%
	List<Article> article = (List<Article>)request.getAttribute("list");
%>
                      ...
                      <tr id="jive-message-780144" class="jive-odd" valign="top">
                        ...
                        <td class="jive-last" width="99%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                              <tr valign="top">
                                <td width="1%"></td>
                                <td width="97%"><span class="jive-subject"><%=str %></span> </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          ...
                                          <!-- 回复帖子 -->
                                          <td class="jive-icon-label"><a href="reply.do?id=<%=art.getId() %>&rootid=<%=art.getRootid() %>" title="回复本主题">回复</a> </td>
                                           <!-- 删除帖子 -->
                                           <td class="jive-icon-label"><a href="delete.do?id=<%=art.getId()%>&isleaf=<%=art.getIsLeaf()%>&pid=<%=art.getPid()%>">删除</a> </td>
                                        </tr>
