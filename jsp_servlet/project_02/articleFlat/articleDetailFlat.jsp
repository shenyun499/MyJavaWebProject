...
<%@ page import="com.base.demo.mysql.*,java.sql.*,com.base.demo.article.*,java.util.*" %>
<%
	...
	String sql = "select *from article where rootid="+rootid+" order by pdate asc ";
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          ...
                                          <!-- 回复帖子 -->
                                          <td class="jive-icon-label"><a href="replyFlat.jsp?id=<%=art.getId() %>&rootid=<%=art.getRootid() %>" title="回复本主题">回复</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div></td>
